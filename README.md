...
| Cost efficiency | Cloud/API spend per run within budget cap — proposed **$1.00 per end-to-end run, per implementation** (gpt-4.1-mini token costs + SerpAPI free tier); see Open Questions in `ROADMAP.md` (local only) |
